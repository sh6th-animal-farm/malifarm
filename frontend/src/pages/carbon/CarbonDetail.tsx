...
export default function CarbonDetail() {
  ...
  const imageList = [
    detailData.thumbnailUrl || '/resources/img/carbon_sample.jpg',
  ];
  ...
  const infoItems = [
    ...
    {
      label: '발급 수량',
      value: `${Number(carbonInfo.initAmount || 0).toLocaleString()} tCO2e`,
    },
    {
      label: '재고 수량',
      value: `${Number(carbonInfo.cpAmount || 0).toLocaleString()} tCO2e`,
    },

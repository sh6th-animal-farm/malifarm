    ...
    <div className="flex min-h-[calc(100dvh-var(--spacing-header-height))] flex-col items-center justify-center px-6 py-10">
      ...
      >
        <form onSubmit={onSubmit}>
          {/* 이메일 */}
          <div className="mb-5">
            <label className="font-caption-03 text-gray-900">이메일 주소</label>
            <Input
              type="email"
              placeholder="example@mlfarm.com"
              required
              value={email}
          ...
          {/* 비밀번호 */}
          <div className="mb-5">
            <label className="font-caption-03 text-gray-900">비밀번호</label>
            <Input
              type="password"
            ...
            <div className="min-h-[24px] mt-2">
              {error && <p className="font-caption-01 text-error">{error}</p>}
            </div>
          </div>

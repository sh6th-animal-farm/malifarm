    ...
    <section className="rounded-lg bg-white shadow-std">
      <div className="overflow-x-auto">
        <div className="min-w-max md:min-w-full">
          <div className="grid grid-cols-[1fr_1.8fr_1fr_1fr_0.9fr_1.2fr] gap-2 bg-gray-50 px-4 py-3 font-body-02 text-gray-500 lg:grid-cols-[0.8fr_2fr_1fr_1fr_0.9fr_1.2fr] lg:pr-6 lg:pl-0 lg:py-4">

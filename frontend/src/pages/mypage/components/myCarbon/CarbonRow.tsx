...
export default function CarbonRow({ item }: CarbonRowProps) {
  ...
  return (
    <div
      className="grid grid-cols-[1fr_1.8fr_1fr_1fr_0.9fr_1.2fr] items-center gap-2 border-t border-gray-100 px-4 py-5 font-body-01 text-gray-800 lg:grid-cols-[0.8fr_2fr_1fr_1fr_0.9fr_1.2fr] lg:pr-6 lg:pl-0"
    >
      <div className="flex justify-center">
        <Badge variant={badge.variant} width="auto">
          {badge.label}
        </Badge>
      </div>

// src/components/carbon/CarbonBadge.tsx
...
export default function CarbonBadge({ type, vintageYear }: CarbonBadgeProps) {
  ...
  const bgColor = isRemoval ? "bg-[var(--color-success-light)]" : "bg-[var(--color-info-light)]";
  const textColor = isRemoval ? "text-[var(--color-success)]" : "text-[var(--color-info)]";
